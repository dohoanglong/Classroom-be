...
const generate = (email, courseId, teacherId, role) => {
    ...
    return jwt.sign({ email, courseId, teacherId, role, expiration: date }, process.env.JWT_SECRET_KEY_JOINCLASS);

}

export const generateInvitationLinkSendViaEmail = async ({ email, courseId, teacherId,role }) => {
